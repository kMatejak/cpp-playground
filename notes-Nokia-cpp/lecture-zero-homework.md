...
## __[sld.17]__ Structures and classes, Special methods  
  
### Constructor
  
- used to initialization objects
- allocates memory
- can have arguments
- overloading is possible
- can be default, delete
  
__Types__
  
- Default constructor `M::M();`
- Copy constructor    `M::(const M&);`
- Move constructor    `M::M(&&);`
  
Can be generated by compiler (copy and move assigment only)  
  
### Destructor  
  
- used to destroying objects
- deallocates memory
...
## __[sld.18]__ Structures and classes, Static members, static methods, const methods  
